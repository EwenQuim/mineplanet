  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        <Image source={require('../assets/images/minefieldWon.jpeg')} style={styles.image} />
        <Text >Your goal is clear: you're a MineSweeper trying to clear the path!  </Text>
        <Text style={{ fontWeight: 'bold' }}>Discover all non-bomb tiles to win.  </Text>
      ...
      <View style={styles.section}>
        ...
        <Text > <Text style={{ fontWeight: 'bold' }}>Long press a third time</Text> to go back to normal.  </Text>
      </View>
